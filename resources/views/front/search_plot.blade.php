          ...
          <div class="advance-search-body">
            ...
            <div class="advance-search-checkboxes">
              <div class="first-checkboxes">
                ...
                <div>
                  <div>
                    <input  id="nsima_Basement" type="checkbox" id="nsima_Basement" class="custom-checkbox_new " <?php if(isset($_SESSION["nsima_EnclosedGarden"]))  { echo "checked"; } ?> >
               ...
               <div> 
                  <div>
                    <input type="checkbox" id="nsima_Outbuildings" class="custom-checkbox_new" <?php if(isset($_SESSION["nsima_Outbuildings"]))  { echo "checked"; } ?>   >
                    <label class="checkbox-label">Outbuildings</label>
                  </div>
              </div>   

             <div>
                  <div>
                    <input type="checkbox" id="nsima_Water"  class="custom-checkbox_new" <?php if(isset($_SESSION["nsima_Water"]))  { echo "checked"; } ?>>
            ...
            <div>
                  <div>
                    <input type="checkbox" id="nsima_Electricity"   class="custom-checkbox_new" <?php if(isset($_SESSION["nsima_Electricity"]))  { echo "checked"; } ?>>
