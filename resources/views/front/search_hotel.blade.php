            ...
            <div class="advance-search-checkboxes" >
              <div class="first-checkboxes">
                ...
                <div>
                  ...
                  <div>
                    <input type="checkbox" class="custom-checkbox_new" id="nsima_DiningRoom" <?php if(isset($_SESSION["nsima_DiningRoom"]))  { echo "checked"; } ?>>
                    <label class="checkbox-label">Dining Room</label>
                  </div>
