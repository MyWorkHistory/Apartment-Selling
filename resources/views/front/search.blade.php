  ...
  <style>
    ...
    @media only screen and (min-width: 600px) 
    {
               ...
               <div style="display: flex; margin-top: 3px;">
                ...
                <div style="display: flex; margin-top: 3px;">
                  ...
                  <div class="advance-search-dropdown">
                    ...
                    <?php if(isset( $_SESSION["nsima_build_type_value"] )) {?>
                      <option class="dropdown-item" value='<?php echo $_SESSION["nsima_build_type_value"]  ?>' ><?php echo $_SESSION["nsima_build_type"]  ?></option>
                    <?php } ?>  
                      <option class="dropdown-item" value="0" ></option>
     ...
     function fastsearch(valu)
     {
     if(valu != 0){
     window.location.href = site + "/bg/fast-search-results/" + valu + "/page-1";
     }
}
    </script>