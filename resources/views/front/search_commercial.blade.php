            ...
            <div class="advance-search-inputs">
              <div class="advance-search-inputs-div">
               ...
               <div style="display: flex; margin-top: 3px;">
                ...
                <div>
                  <label class="label"> Town or village </label>
                  <input id="townorvillage" type="text" class="newformtwo" <?php if(isset( $_SESSION["townorvillage"] )) {?>  value='<?php echo  $_SESSION["townorvillage"] ; }   ?>'  >
                </div>
              ...
              <div class="advance-search-prices">
                ...
                <div>
                  <label>Builded Area Sq M from</label>
            ...
            <div class="advance-search-checkboxes" >
              ...
              <div class="second-checkboxes">
                <div>
                  ...
                  <div>
                    <input type="checkbox" class="custom-checkbox_new" id="nsima_Lift"  <?php if(isset($_SESSION["nsima_Lift"]))  { echo "checked"; } ?>>
